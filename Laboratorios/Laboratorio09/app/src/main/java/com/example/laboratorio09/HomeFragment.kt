...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.mainThreadButton.setOnClickListener{
            it.findNavController().navigate(R.id.action_mainThreadFragment_to_homeFragment)
        }

        binding.coroutinesButton.setOnClickListener{
            it.findNavController().navigate(R.id.action_mainThreadFragment_to_coroutinesFragment)
        }
    }
}